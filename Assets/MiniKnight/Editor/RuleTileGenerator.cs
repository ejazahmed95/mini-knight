...
/// <summary>
/// Referred from the video https://www.youtube.com/watch?v=yI8fMXbtjew 
/// </summary>
...
public class RuleTileGenerator : EditorWindow {
    ...
    public List<Vector3Int> neighbourPositions = new List<Vector3Int>() {
        new(-1, 1, 0),
        new(0, 1, 0),
        new(1, 1, 0),
        new(-1, 0, 0),
    ...
    [MenuItem("EATools/Editor Windows/Rule Tile Generator")]
    ...
    void LoadTemplate() {
        ...
        foreach (var item in templateSprites) {
            ...
            foreach (var neighbor in neighbourPositions) {
                int xPos = 0;
                int yPos = 0;
